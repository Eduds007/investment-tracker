...
import MilionarioPage from './MilionarioPage'
  ...
  return (
    <div className="w-full px-4 py-6 sm:px-6 lg:px-8">
      <div className="mb-8 flex flex-col items-center justify-between gap-3 sm:flex-row sm:items-center">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <div className="flex gap-2 sm:ml-6">
            ...
            <Link to="/milionario"    className={navClass('/milionario')}>Milionário</Link>
          </div>
        </div>
      ...
      <Routes>
        ...
        <Route path="/milionario"     element={<MilionarioPage refreshKey={refreshKey} />} />
      </Routes>
