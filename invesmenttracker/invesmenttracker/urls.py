...
urlpatterns = [
    ...
    path('api/sugestao-investimento/', views.sugestao_investimento, name='sugestao-investimento'),
    ...
    path('api/importar-extrato/', views.importar_extrato, name='importar-extrato'),
]
